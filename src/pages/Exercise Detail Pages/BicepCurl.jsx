...
import '../../pages/pose-pages/pose-bicep-curl';

import mainimage from '../../assets/exercise-media/bicep-curl/main-image.gif';
    ...
    <div>
      ...
      <div className="exercises-container">
        ...
        <div className="exercises-header">
          <h1 className="exercises-title">Bicep<br />Curl</h1>
          <h2 className="wahtis-title">What is Bicep Curl?</h2>
          ...
          <div className="ctb">
            <Link to="/pose-pages/pose-bicep-curl" className="ctb-btn">
              Try With PoseFit
            </Link>
          </div>
        </div>
